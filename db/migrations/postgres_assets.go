...
var PostgresMigrations migrate.MigrationSource = &migrate.MemoryMigrationSource{
	Migrations: []*migrate.Migration{
		{
			Id: "postgres/0001_initial_migration.sql",
			Up: []string{
		...
		{
			Id: "postgres/0010_client_metadata_field_changed.sql",
			Up: []string{
		...
		{
			Id: "postgres/0011_case_insensitive_emails.sql",
			Up: []string{
